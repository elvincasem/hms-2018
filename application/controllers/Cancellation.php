...
class Cancellation extends CI_Controller
{
	...
	public function index()
	{
		$data = $this->data;
		$data['page'] = "index";
		$data['details'] =array('instname'=>"Cancellation Lists") ;
		//$data['contact_list'] = $this->contacts_model->get();
		//$data['hei_list'] = $this->contacts_model->gethei();
		$data['cancellation_list'] = $this->cancellation_model->getbooking_details();
		//print_r($data['details']);
		
		
		
		$this->load->view('inc/header_view');
		$this->load->view('cancellation/cancellation_view',$data);
