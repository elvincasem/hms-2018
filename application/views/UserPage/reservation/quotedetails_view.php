	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<style>span.tab{padding: 0 150px;}</style>
							...
							<b>Quote No. :&emsp;  <?php echo $bookingids;?><span class="tab"></span>
							<b>Guest Name: &emsp; <?php echo $quote_main->gname;?><span class="tab"></span>
							<b>Arrival: &emsp; <?php echo $quotebooking_details['quotecheckin'];?><br>
							<b>Address: 		<span class="tab"></span>						
							<b>Departure: &emsp; <?php echo $quotebooking_details['quotecheckout'];?><span class="tab"><br>
							<b>Receptionist: &emsp; <?php echo $quote_main->receptionists;?>&emsp;<span class="tab"></span>
							<b>Reservation Source: &emsp;<?php echo $quote_main->ressource;?><br>
							<b>Quote Date: &emsp; <?php echo $quote_main->bookingdate;?>
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				<tr>
					...
					<td><?php echo $quotebooking_details['quotecheckin'];?> <br> <?php echo $quotebooking_details['quotecheckout'];?></td>
