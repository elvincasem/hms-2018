								...
								<datalist id="camount">
                                    ...
                                    <div id="modal-cash" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="cdatepaid" name="example-datepicker" class="form-control input-datepicker" data-date-format="yyyy-mm-dd"  value="<?php echo date('Y-m-d');?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="camount" name="state-normal" class="form-control" value="">
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<style>span.tab{padding: 0 150px;}</style>
							...
							<b>Resevation No. :&emsp;  <?php echo $bookingid;?><span class="tab" id="bookid"></span>
							
							<b>Guest Name: &emsp; <?php echo $reservation_main->guests;?><span class="tab" id="bookid"></span>
							<b>Arrival: &emsp; <?php echo $booking_details['checkin'];?><br>
							<b>Address: 		<span class="tab"></span>						
							<b>Departure: &emsp; <?php echo $booking_details['checkout'];?><span class="tab" id="bookid"><br>
							<b>Receptionist: &emsp; <?php echo $reservation_main->receptionist;?>&emsp;<span class="tab"></span>
							<b>Reservation Source: &emsp;<?php echo $reservation_main->reservationsource;?><br>
							<b>Booking Date: &emsp; <?php echo $reservation_main->bookingdate;?>
