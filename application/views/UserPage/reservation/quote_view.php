	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				echo "<tr>";
				echo "<td><a href='".base_url()."Staff/Quote/quotedetails/".$quote_module['bookingids']."'>".$quote_module['bookingids']."</a></td>";
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<style>span.tab{padding: 0 150px;}</style>
							...
							<b>Quote No. : &emsp; <b  style="color: red;"  id="bokids"></b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
							<br>
							<b>Guest Name: &emsp; <b  style="color: red;" id="gnames"></b>&emsp;&emsp;&emsp;&emsp;&emsp; 					
							<b>Arrival: &emsp;<b  style="color: red;" id="inquote"></b><br>
							<b>Address: 		<span class="tab"></span>						
							<b>Departure: &emsp; <b  style="color: red;" id="outquote"></b><span class="tab"><br>
							<b>Receptionist: &emsp; <b  style="color: red;" id="receps"></b>				&emsp;<span class="tab"></span>
							<b>Reservation Source: &emsp; <b  style="color: red;" id="qsource"></b><br>
							<b>Booking Date: &emsp; <b  style="color: red;" id="bd"></b> 
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
                <thead>
                    <tr>
