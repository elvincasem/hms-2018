	...
	<div class="block full">
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				echo "<tr>";
				echo "<td><a href='".base_url()."Staff/reservation/details/".$booking_main['bookingid']."'>".$booking_main['bookingid']."</a></td>";
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<style>span.tab{padding: 0 150px;}</style>
							...
							<b>Resevation No. : &emsp; <b  style="color: red;" id="bookid"></b><span class="tab" id="bookid"></span>
<br>
							
							<b>Guest Name: &emsp; <b  style="color: red;" id="guestsname"></b><span class="tab" id="bookid"></span> 					
							<b>Arrival: &emsp;<b  style="color: red;" id="checkin"></b><br>
							<b>Address: 		<span class="tab"></span>						
							<b>Departure: &emsp; <b  style="color: red;" id="checkout"></b><span class="tab" id="bookid"><br>
							<b>Receptionist: &emsp; <b  style="color: red;" id="recep"></b>				&emsp;<span class="tab"></span>
							<b>Reservation Source: &emsp; <b  style="color: red;" id="source"></b><br>
							<b>Booking Date: &emsp; <b  style="color: red;" id="bookdate"></b> 
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
                <thead>
                    <tr>
