	...
	<div class="block full">
        <div class="block-title">
					 ...
					 <div class="form-group">
										 ...
										 <input type="button" name="filter" id="filter" value="Filter" class="btn btn-info" onclick="cardfilters();"/>  </button>
										<p>
		  
                    <h2 class="page-header" style="color:#000; font-size: 20px;"><i class="fa fa-book fa-2x"></i>Card Sales Report</h2>
        ...
        <div class="table-responsive" id="card_tables">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				foreach ($card_list as $bill_payment):
						...
						<script>function printContent()
{
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<center><h1>Card Sales Report</h1></center>
