	...
	<div class="block full">
        <div class="block-title">
					 ...
					 <div class="form-group">
										 ...
										 <input type="button" name="filter" id="filter" value="Filter" class="btn btn-info" onclick="bankfilters();"/>  </button>
										<p>
		  
                    <h2 class="page-header" style="color:#000; font-size: 20px;"><i class="fa fa-book fa-2x"></i>Bank Sales Report</h2>
        ...
        <div class="table-responsive" id="bank_tables">
            ...
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				foreach ($bank_list as $bill_payment):
						...
						<script>function printContent()
{
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<center><h1>Bank Deposit Sales</h1></center>
						<center> <img src="<?=base_url()?>public/img/logo.jpg" alt="image" height="100px" width="300px"></center>
