	...
	<div class="block full">
        <div class="block-title">
						 ...
						 <div class="form-group">
										 ...
										 <input type="button" name="filter" id="filter" value="Filter" class="btn btn-info" onclick="receivables();"/></button>
										<p>
		  
                    <h2 class="page-header" style="color:#000; font-size: 20px;"><i class="fa fa-book fa-2x"></i>Collection of Accounts Receivable</h2>
					<a href='#modal-large' data-toggle='modal'  type='button' class='btn btn-effect-ripple btn-info'><i class='fa fa-print'></i></a>
						</div>
						
                          
               
			<?php //print_r($heidirectory);?>
        <div class="table-responsive" id="receivable_tables">
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				foreach ($receivable_list as $bill_payment):
				...
				echo "<td>".$bill_payment['checkin']."</td>";
				echo "<td>".$bill_payment['checkout']."</td>";
				echo "<td>".$bill_payment['roomNames']."</td>";
						...
						<script>function printContent()
{
	...
	setTimeout(function(){
		...
		WindowObject.close();
						...
						<center><h1>Collection of Accounts Receivable Reports</h1></center>
						<center> <img src="<?=base_url()?>public/img/logo.jpg" alt="image" height="120px" width="190px"></center>
						
						<style>span.tab{padding: 0 150px;}</style><br>
						
						<div class="table-responsive" id="receivable_table">
		<style>
table, th, td {
