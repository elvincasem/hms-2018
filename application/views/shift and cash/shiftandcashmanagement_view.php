	...
	<div class="block full">
        ...
        <div class="table-responsive" id="order_tabless">
            <table id="example-datatable" name="filter" class="table table-striped table-bordered table-vcenter table-hover" style="color: black;">
				...
				echo "<tr>";
				echo "<td><a href='".base_url()."reservation/details/".$bill_payment['bookingid']."'>".$bill_payment['bookingid']."</a></td>";
...
table, th, td {
    ...
    border-collapse: collapse;
            ...
            <table id="example-datatable" name="filter" class="table table-striped table-bordered table-vcenter table-hover" style="color: black; width: 100%;">
                <thead>
                    <tr>
						 <th>Booking ID</th>
                        <th>Date Paid</th>
