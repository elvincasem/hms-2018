...
class confirmed_model extends CI_Model
{
	...
	public function getbooking_details()
	{
		...
		$account = $this->db->query("SELECT * FROM booking_details,bill_payment,booking_main where booking_details.bookingid=bill_payment.bookingid and booking_details.bookingid=booking_main.bookingid");
